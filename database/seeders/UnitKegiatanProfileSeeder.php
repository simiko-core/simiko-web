...
class UnitKegiatanProfileSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $profiles = [
            'HMIF' => [
                'vision' => 'Menjadi himpunan mahasiswa informatika yang unggul dalam pengembangan teknologi informasi dan komputer untuk kemajuan bangsa.',
            ...
            'HMTE' => [
                'vision' => 'Menjadi himpunan mahasiswa teknik elektro yang terdepan dalam inovasi teknologi elektro dan elektronika.',
            ...
            'HMTM' => [
                'vision' => 'Menjadi himpunan mahasiswa teknik mesin yang berkualitas dalam pengembangan teknologi manufaktur dan industri.',
            ...
            'HMTS' => [
                'vision' => 'Menjadi himpunan mahasiswa teknik sipil yang berperan aktif dalam pembangunan infrastruktur berkelanjutan.',
            ...
            'UKM Foto' => [
                'vision' => 'Menjadi unit kegiatan mahasiswa fotografi yang kreatif dan inovatif dalam seni visual.',
            ...
            'UKM Musik' => [
                'vision' => 'Menjadi wadah kreativitas musik mahasiswa yang dapat menginspirasi dan menghibur masyarakat.',
            ...
            'UKM Sport' => [
                'vision' => 'Menjadi unit kegiatan olahraga yang mencetak atlet-atlet berprestasi dan mempromosikan hidup sehat.',
            ...
            'UKM PA' => [
                'vision' => 'Menjadi komunitas pecinta alam yang peduli lingkungan dan mempromosikan ekowisata.',
            ...
            'UKM Robot' => [
                'vision' => 'Menjadi pusat pengembangan robotika dan otomasi yang inovatif dan berdaya saing.',
            ...
            'UKM Debat' => [
                'vision' => 'Menjadi wadah pengembangan kemampuan berbicara dan berpikir kritis mahasiswa.',
        ...
        foreach ($units as $unit) {
            $profileData = $profiles[$unit->alias] ?? [
                'vision' => 'Menjadi unit kegiatan mahasiswa yang unggul dan berprestasi.',
